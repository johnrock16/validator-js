...
var dataValidatedWrong = dataValidate(fieldsNotWorking, { validationHelpers: myValidator, rules: myValidatorRules_default, dataRule: contactUs_default, dataErrorMessages: myValidatorRules_default2 });
var dataValidatedWrongWIthoutErrorMessage = dataValidate(fieldsNotWorking, { validationHelpers: myValidator, rules: myValidatorRules_default, dataRule: contactUs_default });
var dataValidatedCorrectly = dataValidate(fieldsWorking, { validationHelpers: myValidator, rules: myValidatorRules_default, dataRule: contactUs_default, dataErrorMessages: myValidatorRules_default2 });
console.log(dataValidatedWrong);
console.log(dataValidatedWrongWIthoutErrorMessage);
console.log(dataValidatedCorrectly);
var RULES = { ...myValidatorRules_default, ...name_rule_default };
var DATA_RULES = { ...contactUs_default, ...name_data_rule_default };
var validatorHelpers = (value, rule, modifier = null, data = null) => ({
...
var dataValidatedCorrectlyWithInheritanceAndVariables = dataValidate(fieldsWorking2, { validationHelpers: validatorHelpers, rules: RULES, dataRule: DATA_RULES, dataErrorMessages: myValidatorRules_default2 });
